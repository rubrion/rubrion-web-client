          ...
          <div className="relative z-10 max-w-md w-full px-8">
            {!showComplete ? (
              <>
                ...
                >
                  <div className="text-accent-green mb-1">$ rubrion --init --verbose</div>
                  <div className="text-text-muted">[INFO] Inicializando plataforma Rubrion...</div>
                  <div className="text-text-muted">[INFO] Carregando arquivos de configuração...</div>
                  <div className="text-accent-cyan">[SUCESSO] Todos os sistemas operacionais</div>
                </motion.div>
              </>
            ) : (
              <motion.div
              ...
              >
                ...
                >
                  Experiência de código concluída!
                </motion.h2>
                <motion.p
