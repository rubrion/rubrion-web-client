            ...
            {!showComplete ? (
              <>
                ...
                >
                  ...
                  <div className="text-text-muted">[INFO] Initializing Rubrion platform...</div>
                  <div className="text-text-muted">[INFO] Loading configuration files...</div>
                  <div className="text-accent-cyan">[SUCCESS] All systems operational</div>
                </motion.div>
              </>
            ) : (
              <motion.div
